...
## Prior work
  ...
  - x[STMCube.AI]: Map and run pre-trained NNs on STM32 microcontrollers.
  - x[CMSIS-NN]: A collection of efficient NN kernels to maximize performance and minimize memory footprint in ARM Cortex-M processors.
  - x[uTensor]: A machine learning framework for Mbed and Tensorflow that converts a NN into C++ code.
